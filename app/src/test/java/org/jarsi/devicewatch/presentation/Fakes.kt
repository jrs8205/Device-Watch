...
/** Report headings shared by the report tests; English so assertions read plainly. */
internal val TEST_REPORT_LABELS = HtmlReportLabels(
    ...
    searchHintDays = "Try a date such as 2026-08-14",
    searchHintLog = "Try an app name such as Gmail",
    rangeWeek = "7 days",
    rangeMonth = "30 days",
    rangeAll = "All",
    rangeFrom = "From",
